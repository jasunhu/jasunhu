...
# 原版安装地址：https://raw.githubusercontent.com/wulabing/V2Ray_ws-tls_bash_onekey/master/install.sh
#====================================================
# V2ray+WS+TLS一键安装
# 进入root账户
# sudo -i
# yum install -y wget && wget -N --no-check-certificate -q -O V2ry.sh  https://raw.githubusercontent.com/jasunhu/jasun/main/sh/V2ry.sh
# 执行
# chmod +x V2ry.sh
# bash V2ry.sh
# bash install.sh
